...
<head>
    <script type="text/javascript">
        ...
        function setAge(){
            if(Number(document.form1.age.value)>=40||Number(document.form1.age.value)<1){
                document.getElementById("age1").innerHTML="<font color='red'>请输入1-40的数字</font>";
                return false;
            }
            else{
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <div class="button navbar-right">
                ...
                <button class="navbar-btn nav-button wow bounceInRight login" data-wow-delay="0.8s"><a href="login.jsp">已有账号？去登陆</a></button>
            ...
            <form name="form1" method="post" action="">
                <table align="center" width="570" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="154"><label for="usr4"></label><span id="username"></span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><div align="right">
                            <input name="passwd" type="password" id="passwd" style="color:#000" onblur="setPassword1()" size="30">
                        </div></td>
                        <td><label for="passwd"></label><span id="passwd1"></span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><div align="right"></div></td>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><div align="right">
                            <input name="againpasswd" type="password" id="againpasswd" style="color:#000" onblur="setPassword2()" size="30">
                        </div></td>
                        <td><label for="againpasswd"></label><span id="passwd2"></span></td>
                    ...
                    <tr>
                        ...
                        <td><label for="email"></label><span id="mail"></span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><div align="right"></div></td>
                    ...
                    <tr>
                        <td><div align="left">教龄</div></td>
                        <td colspan="2"><div align="right">
                            <input name="age" type="text" id="age" style="color:#000" onblur="setAge()" size="30">
                        </div></td>
                        <td><label for="age"></label><span id="age1"></span></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td colspan="2"><div align="right"></div></td>
                    ...
                    <tr>
                        ...
                        <td width="103"><div align="right">
                            <select id="pro" name="province" style="color: #555555" onChange="chooseAera()">
                                <option>保密</option>
                                <script type="text/javascript">
                        ...
                        <td width="93"><div align="right">
                            <select id="city" name="citys" style="color: #5A5A5A">
                                <option>保密</option>
                            </select>
                        </div></td>
                        <td width="154">&nbsp;</td>
