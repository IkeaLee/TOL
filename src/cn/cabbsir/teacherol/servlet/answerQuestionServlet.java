...
public class answerQuestionServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //测试代码
        System.out.println("answerQuestionServlet");
        String answer = request.getParameter("ans");
        UserInfoDao udao = new UserInfoDao();
        String answeruser = request.getParameter("ansusr");
        System.out.println("SelectTName");
        ...
        if(dao.InsertAnswer(answer,answeruser,Integer.parseInt(id))==0||answer==null){
            ...
            ArrayList<QuestionInfo> que=dao.SelectTunAnswered(loginuser.getTeachingArea());
            session.setAttribute("questionss",que);
