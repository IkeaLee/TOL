...
@WebServlet(name = "UpdateS1Servlet",urlPatterns = "/UpdateS1Servlet")
public class UpdateS1Servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(updateUser==0){
            ...
            response.sendRedirect("myprofileS1.jsp");
        }
        else{
            //测试代码
            System.out.println("更改通过");
            request.getRequestDispatcher("updateSuccess1.jsp").forward(request,response);
        }
    }
